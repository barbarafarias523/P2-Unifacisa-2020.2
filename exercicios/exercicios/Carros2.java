public class Carros {
	...
	Carros(String nome, String marca, Cor cor, int portas, boolean vidroEletrico, boolean arCondicionado, boolean cambioAutomatico, boolean direcaoEletrica, double precoBase) {
		this.nome = nome;
		this.marca = marca;
		this.cor = cor;
		this.portas = portas;
	...
	public String toString() {
		...
		descricao += "Total: " + calculaPreco() + ", Promoção: " + (Carros.promocao ? "sim" : "não") + "\n";
		return descricao;
